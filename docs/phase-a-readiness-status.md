...
This file prevents the schema/template work from being mistaken for product-sourcing progress.
...
- Amazon Associates readiness: **defer signup unless 3-sale requirement can be met**
  - Do not start the 180-day clock before pages are indexed and capable of driving qualifying purchases.
- Hands-on trust evidence: **not complete**
  - Minimum before publishing all six pages: at least 8 tested/handled products across at least 3 categories, with at least 1 tested/handled product on every published page.
